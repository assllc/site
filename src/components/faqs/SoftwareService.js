...
import Software from "images/undraw_experience_design_re_dmqq.svg"

const Container = tw.div`relative`;
const Content = tw.div`max-w-screen-xl mx-auto mr-40 py-16 lg:py-20`;
...
const QuestionToggleIcon = styled.span`
  ${tw`mr-2 bg-primary-500 text-gray-100 p-1 rounded-full group-hover:bg-primary-700 group-hover:text-gray-200 transition duration-300`}
  svg {
    ${tw`w-4 h-4`}
  }
`;
...
export default ({
  ...
  description = "When it comes to software, one size does not fit all. Software customized for your company that fits like a tailored suit, designed specifically for you and your needs. Let us simplify your processes and automate your workflows. Say goodbye to the mundane and free up your time for what matters.",
  imageSrc = Software,
  imageContain = true,
  imageShadow = false,
  faqs = null
  ...
  const defaultFaqs = [
    {
      question: "Monolith and Microservice Architectures",
      answer:
    ...
    {
      question: "System integrations and automations",
      answer:
    ...
    {
      question: "Website design and implementation",
      answer:
